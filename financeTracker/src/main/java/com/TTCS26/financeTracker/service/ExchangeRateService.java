...
public class ExchangeRateService {
    ...
    // Lấy lịch sử tỷ giá theo số ngày
    public List<CurrencyRate> getHistory(String baseCurrency, String targetCurrency, int days) {
        LocalDateTime fromDate = LocalDateTime.now().minusDays(days);
        return currencyRateRepository.findByBaseCurrencyAndTargetCurrencyAndFetchDateAfter(
